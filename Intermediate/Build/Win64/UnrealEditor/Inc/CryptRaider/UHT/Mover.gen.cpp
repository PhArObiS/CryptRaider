...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMover_Statics::NewProp_MoveOffset_MetaData[] = {
		...
		{ "Comment", "// Macro to make the variable editable in the editor\n" },
#endif
		{ "ModuleRelativePath", "Mover.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Macro to make the variable editable in the editor" },
#endif
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMover_Statics::NewProp_MoveTime_MetaData[] = {
		{ "Category", "Mover" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// How far to move the object\n// Variable editable in the editor\n" },
#endif
		{ "ModuleRelativePath", "Mover.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "How far to move the object\nVariable editable in the editor" },
#endif
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMover_Statics::NewProp_ShouldMove_MetaData[] = {
		{ "Category", "Mover" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Variable editable in the editor\n" },
#endif
		{ "ModuleRelativePath", "Mover.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Variable editable in the editor" },
#endif
	};
#endif
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CryptRaider_Source_CryptRaider_Mover_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMover, UMover::StaticClass, TEXT("UMover"), &Z_Registration_Info_UClass_UMover, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMover), 712777844U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CryptRaider_Source_CryptRaider_Mover_h_2650485519(TEXT("/Script/CryptRaider"),
